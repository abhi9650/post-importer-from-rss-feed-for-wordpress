<?php
/*
Plugin Name: EditMeet Press Releases
Plugin URI: http://editmeet.com
Description: EditMeet Press Releases Plugin. Please do not update. 
Version: 1.0.0.1
Author: EditMeet
Author URI: http://editmeet.com
License: http://editmeet.com
*/
...
function fwp_add_pages () {
	...
	add_submenu_page(
		$syndicationMenu, 'Editmeet', 'Syndicated site',
...
<?php
	...
	public function dashboard_setup () {
		...
		if (current_user_can($see_it)) :
			...
			$widget_name = __('Editmeet Press Releases Source');
			$column = 'side';
			$priority = 'core';

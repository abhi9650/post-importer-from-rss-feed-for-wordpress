...
class FeedWordPressPostsPage extends FeedWordPressAdminPage {
	 ...
	 */
	/*static*/ 
	function links_box ($page, $box = NULL) {
		$setting = array(
			'munge_permalink' => array(
				//'no' => __('The copy on the original website'),
				'yes' => __('The local copy on this website'),
			),
		);
		...
		<p class="setting-description">Some feeds (for example, those produced by Editmeet) aggregate content from several different sources, and include information about the original source of the post.
...
?>
	<h3 style="display:none;">Advanced Settings</h3>
	<table class="edit-form narrow" style="display:none;">
	<tbody>
